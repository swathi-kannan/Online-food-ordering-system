...
if(isset($_POST['delete_after_parcel'])){
        $del = "TRUNCATE TABLE cart";
          $result1= mysqli_query($conn,$del);
          if($result1){
    ...
    <body>
      ...
      <table  style="height:400px;width:800px;">
        ...
        if(mysqli_num_rows($result) > 0)
        {
          ...
          {
        ?>
<form method="POST" action="parcelbill.php">
<tr>
 ...
 <?php
      $total = $total + $row["item_total"];
          ...
          ?>
<tr> 
   <td> <button class="btn" type="submit" onclick="myalert()" name="submit"><a href="thankyou.html">PAY</a></button></td>
